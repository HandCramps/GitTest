...
<LINK href="images/css1.css" type=${pageContext.request.contextPath}/text/css rel=stylesheet>
<LINK href="images/newhead.css" type=${pageContext.request.contextPath}/text/css rel=stylesheet>
			...
			<TBODY>
					...
					<TD background=images/crm_12.gif colSpan=6>
						<TABLE id=table1 cellSpacing=0 cellPadding=0 width="98%" border=0>
							<TBODY>
								<TR>
									<TD>
										<form action="${pageContext.request.contextPath}/login.jsp" method="post" id="form8">
				...
				<TR>
					...
					<TD><input title=登录项目平台管理系统 type=image height=48 alt=""
						width=86 src="${pageContext.request.contextPath}/images/crm_17.gif" name="image" id="login"></TD>
...
<script>
	$("#login").click(function () {
		$.post("admin/login",{"key":"keny"},function(result){
			console.log(result);
