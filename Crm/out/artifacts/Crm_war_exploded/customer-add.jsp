...
<head>
    ...
    <script type="application/javascript">
        function saveInfo() {
            $.post("${pageContext.request.contextPath}/admin/addCustomer", $("#addcus").serialize(), function (result) {
...
<form name="form2" id="addcus" action="${pageContext.request.contextPath}/admin/saveInfo" method="post">
