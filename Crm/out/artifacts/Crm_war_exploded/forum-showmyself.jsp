...
<head>
    ...
    <script type="text/javascript">
             $(function(){
                 $.ajax({
                     type:'GET',
                     url:'${pageContext.request.contextPath}/forum/getOneByEid',
                     dataType:'json',
                     success:function(resultData){
                       ...
                       $(resultData).each(function(index,item){
                           ...
                           var newdate = new Date(item.createtime);
                            tr += "<td><ul class='notice-list'> <li class='ue-clear'> <span id='p'> <img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/> </span> <br><font>发布时间："+newdate.getFullYear()+"-"+newdate.getMonth()+1+"-"+newdate.getDate()+"</font><br>标题： <a href='${pageContext.request.contextPath}/forum/getForumpostByid?id="+item.forumid+" 'class='notice-title'>"+item.forumtitle+"</a><br><a href='${pageContext.request.contextPath}/forum/deleteForum?id="+item.forumid+"'>删除该贴</a> </li> </ul></td>";
                            if(index!=0 && i%3 ==0 ) {
                                var ttr = tr + "</tr>";
                                $("#ff").before(ttr);
                            }
