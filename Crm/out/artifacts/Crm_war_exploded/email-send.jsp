...
<title>发信息</title>
<script type="text/javascript" scr="js/jquery-1.8.1.js"></script>
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><select></select></td>
</tr>
<tr >
