...
<head>
    ...
    <script type="application/javascript">
        <%--$.get('${pageContext.request.contextPath}/admin/showCustomer',{'show':'show'},function (customerList) {--%>
...
<script>
    $.get("${pageContext.request.contextPath}/admin/showCustomer", {"key": "keny"}, function (customerList) {
        for (var obj in customerList) {
            $("#tr2").after("" +
                "<tr align='center' bgcolor='#FFFFFF' onMouseMove='javascript:this.bgColor='#FCFDEE';' onMouseOut='javascript:this.bgColor='#FFFFFF';' height='22' >\n" +
                "    <td><input name='id' type='checkbox' id='id' class='np' /></td>\n" +
                "    <td>" + customerList[obj].id + "</td>\n" +
                "    <td>" + customerList[obj].camera + "</td>\n" +
                "    <td align='center'>" + customerList[obj].comname + "</td>\n" +
                "    <td>" + customerList[obj].addtime + "</td>\n" +
                "    <td>" + customerList[obj].comphone + "</td>\n" +
